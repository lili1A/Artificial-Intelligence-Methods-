...
print("=" * 60)
print("HEART DISEASE PREDICTION USING GRADIENT BOOSTING")
print("=" * 60)
...
# 6. SAVE THE REQUIRED CSV FILES
print("\n6. SAVING REQUIRED CSV FILES")
print("-" * 40)

# Create output directory
output_dir = "gb_predictions_output"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
    print(f"Created output directory: {output_dir}")


# FILE 1 ALL PREDICTIONS FILE
...
feature_importance = best_model.named_steps['gb'].feature_importances_
...
summary_data = {
    ...
    'Value': [
        ...
        '',
        '',
        str(grid_search.best_params_.get('gb__n_estimators')),
        str(grid_search.best_params_.get('gb__learning_rate')),
        str(grid_search.best_params_.get('gb__max_depth')),
        str(grid_search.best_params_.get('gb__min_samples_split')),
        top_feature,
        '5'
    ]
}
...
performance_metrics = {
    ...
    'Description': [
        ...
        'Shrinkage rate for each tree contribution'
    ]
}
...
print("\nCreating: FEATURE IMPORTANCE FILE")
